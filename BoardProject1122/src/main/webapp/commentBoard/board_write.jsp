	...
	<div align=center>
		...
		<form action="<%=path%>/CommentController" method=get>
			...
			<table border=1>
				...
				<tr>
					<td colspan=2><input type="text" id="sample6_address" name="address" placeholder="주소"></td>
				<tr>
				<tr>
					<td><input type="text" id="sample6_detailAddress" name="detail_address"
						placeholder="상세주소"></td>
					<td><input type="text" id="sample6_extraAddress" name="extra_address"
						placeholder="참고항목"></td>
				</tr>
				<tr>
					<td colspan=2 align=center><input type=submit value="글등록">
